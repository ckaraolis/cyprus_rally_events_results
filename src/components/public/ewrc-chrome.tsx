  ...
  return (
    <div className="ewrc-page min-h-full bg-[var(--ewrc-bg)] text-[var(--ewrc-fg)]">
      <header className="sticky top-0 z-50 border-b border-[var(--ewrc-border)] bg-[var(--ewrc-header-bg)]">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-4 py-2.5 sm:gap-4 sm:px-6">
          <Link href="/" className="group min-w-0 flex items-baseline gap-2">
            <span className="font-ewrc-heading truncate text-base font-bold tracking-tight text-[var(--ewrc-heading)] sm:text-xl">
